...
frame sets. */
let colors = ['#DCDF3A','#DFC23A','#DCDF3A','#DCDF3A','#DCDF3A','#DCDF3A','#83DF3A','#83DF3A','#DCDF3A','#DCDF3A','#DCDF3A'];
let skyColor = ['#007fff','#0059b3','#0066cc','#0059b3','#004c9a','#003f81','#001a35','#000102','#000000','#000000','#000000','#000000','#000000','#000000','#000000','#000000','#000000','#000000','#000000','#000000']
var count = 0;
var moved = false;
var win = false;
var lose = false;
...
(function() { "use strict";
  ...
  render = function(counteur) {
    timeout = Math.round(new Date().getTime() / 1000 - timer);
    /* Draw the background. */
    if(timeout >= 19) {
        timeout = 19;
        if(!win) {
    ...
    console.log(timeout);
    buffer.fillStyle = skyColor[timeout];
